...
//  The bool isHD indicates with algorithm we used (Hamming distance or LCP)
//  The hamming distance at a position i is: size_pattern - res[i]
...
int main(int argc, char* argv[]) {
	...
	bool isHD = true;  // will help to write in the output
